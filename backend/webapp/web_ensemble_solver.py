...
model_1 = keras.models.load_model('/services/djangoapp/ml_models/general_solver_1')
model_2 = keras.models.load_model('/services/djangoapp/ml_models/general_solver_2')
model_3 = keras.models.load_model('/services/djangoapp/ml_models/general_solver_3')
model_4 = keras.models.load_model('/services/djangoapp/ml_models/general_solver_4')
